...
![Diagrame representant le volume du marché par type de body](image/body_volume.png)
...
![Diagrame representant le volume du marché en foànction de l'état du véhicule](image/volume_marge_condition.png)
...
![Diagrame representant le volume du marché en foànction de l'odometer du véhicule](image/volume_odometer.png)
...
![Diagrame representant le volume de ventes en foctnion de l'âge du véhicule ](image/volume_age.png)
...
![Diagrame representant le volume de ventes en foctnion de la couleur du véhicule ](image/volume_couleur.png)
...
![Diagrame representant le volume et l'état des véhicules en foctnion du prix et de marge ](image/prix_marge_volume_contion.png)
...
![Diagrame representant le volume de vente en fonction du body et de l'odometer](image/volue_body_odometer.png)
